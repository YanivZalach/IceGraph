 ...
 * `kebab-case` — so a validation error names the key the payload carried. Ids stay the strings
 * `shared/lib/api.ts` parsed them into, so they never lose precision.
 */
